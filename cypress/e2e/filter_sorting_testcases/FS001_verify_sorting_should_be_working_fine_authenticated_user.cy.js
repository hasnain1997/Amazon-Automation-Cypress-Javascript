...
describe("Verify Sorting should be working fine authenticated user" +
    "- Sort : Low to High Price", function() {
    ...
    it("Verify Sorting should be working fine authenticated user" +
        "- Sort : Low to High Price", function() {
        ...
        homePage.selectLowToHighPriceSorting(1)
        homePage.verifyLowToHighPrice()
    });
